...
<body class="h-full">
    <div
        class="relative overflow-hidden  bg-cover bg-no-repeat p-12 text-center w-full h-full"
        style="background-image: url('{{ asset("img/loginpage.jpg") }}'); ">
        <div class=" justify-center px-6 py-12 lg:px-8">
            <div class="sm:mx-auto sm:w-full sm:max-w-sm">
            <img class="mx-auto h-10 w-auto" src="{{ asset("img/Logo.jpg") }}" alt=">
            ...
            <form class="space-y-6" action="#" method="POST">
                ...
                <div class="mt-2">
                    <input placeholder="Email/Username/NIM/NIP" id="email" name="email" type="email" autocomplete="email" required class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                </div>
                </div>
